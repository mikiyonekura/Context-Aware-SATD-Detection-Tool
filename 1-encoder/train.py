...
def train():
    ...
    #====================================
    with open('/work/miki-yo/MySatdDetector/datasetNew/1-original/data--Merge--5.txt', 'r') as f:
        comments = [line.strip() for line in f.readlines()]  # 各行を読み込み、改行文字を取り除く

    #====================================
    # with open('dataset/label--Argo-Hive-re.txt', 'r') as f:
    #====================================
    with open('/work/miki-yo/MySatdDetector/datasetNew/1-label/label--Merge--5.txt', 'r') as f:
...
if __name__ == '__main__':
    print(f"../datasetNew/1-original/data--Merge--5.txtに対してtrain.pyを実行")
    train()